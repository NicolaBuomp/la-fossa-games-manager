...
// Progetto Supabase del nuovo gestionale (la-fossa-events-management):
// il form pubblico della landing inoltra le richieste a questo database.
const managementSupabaseUrl = pickValue("LFEM_SUPABASE_URL") || "";
const managementSupabaseAnonKey = pickValue("LFEM_SUPABASE_ANON_KEY") || "";

if (!managementSupabaseUrl || !managementSupabaseAnonKey) {
  console.warn(
    "[Warning] LFEM_SUPABASE_URL / LFEM_SUPABASE_ANON_KEY mancanti: " +
      "il form della landing non potra' inoltrare le richieste al nuovo gestionale.",
  );
}
...
export const supabaseConfig = {
  ...
  managementSupabaseUrl: ${JSON.stringify(managementSupabaseUrl)},
  managementSupabaseAnonKey: ${JSON.stringify(managementSupabaseAnonKey)}
};
`;
